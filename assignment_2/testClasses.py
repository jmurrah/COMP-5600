...
class PassAllTestsQuestion(Question):
    def execute(self, grades):
        ...
        for _, f in self.testCases:
            ...
            if end - start > 60:
                print(
                    "WARNING: this question took over 60 seconds to run. This may end up timing out the gradescope autograder"
                )
        if testsFailed:
...
class PartialCreditQuestion(Question):
    ...
    def execute(self, grades):
        ...
        if end - start > 300:
            print(
                "WARNING: this question took over 5 minutes to run. This may end up timing out the gradescope autograder"
            )
