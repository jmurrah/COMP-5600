...
class GameState:
    ...
    def getPossibleHouses(self):
        return layout.pickPossibleLocations(
            self.data.layout.width, self.data.layout.height
        )
...
class HuntersGameRules:
    ...
    def lose(self, state, game):
        print(
            "Uh oh, You found the Princess! Wraaaang she's in another house go away. Score: %d"
            % state.data.score
        )
        game.gameOver = True
...
class PacmanRules:
    ...
    def getLegalActions(state):
        ...
        return Actions.getPossibleActions(
            ...
            state.data.layout.redWalls,
            state.data.layout.blueWalls,
        )
...
def readCommand(argv):
    ...
    parser.add_option(
        ...
        action="store_true",
        dest="randomBoard",
        help="Generates some random board",
        default=False,
    )
    parser.add_option(
        "-v",
    ...
    parser.add_option(
        ...
        type="str",
        dest="seed",
        help=default("Generates a random board using the specified seed"),
        default=None,
    )
    ...
    args["display"] = graphicsDisplay.FirstPersonPacmanGraphics(
        options.zoom, options.displayGhosts, frameTime=options.frameTime, hunters=True
    )
